...
func GetVueTableDataWithContext(ctx context.Context, db *sql.Conn, paginator models.Paginator) models.Pagination {
...
func DownloadVueTableDataWithContext(ctx context.Context, db *sql.Conn, paginator models.Paginator) (rowData []interface{}, headrs []string) {
